...
public class AskTeacherActivity extends BaseActivity {
	...
	private void initData() {
		final String user = mUser.getUsername();
		final String pwd = CyptoUtils.decode("APPICLASS", mUser.getPassword());
		String url = URLs.makeURL(URLs.ASK_TEACHER, new HashMap<String, Object>() {{
			put("username", user);
			put("password", pwd);
		}});
